...
include('inc_session.php');
   ...
   $req->closeCursor();
		...
		$res=$bds->prepare('SELECT id,name,permission,message,date,heure,society FROM messanger WHERE code= :code AND email_ocd= :email_ocd ORDER BY id DESC LIMIT 0,2');
